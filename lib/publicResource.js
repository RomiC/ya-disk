 ...
 */
import { get as requestGet, post as requestPost } from './request.js';
 ...
 */
export const get = async (token, public_key, options = {}) =>
  (
    await requestGet({
 ...
 */
export const download = async (token, public_key, path) =>
  (
    await requestGet({
 ...
 */
export const saveToDisk = async (token, public_key, path, name) =>
  (
    await requestPost({
 ...
 */
export const list = async (token, options) =>
  (
    await requestGet({
      url: API_PUBLIC_URL,
      token,

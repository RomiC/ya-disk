 ...
 * @see https://yandex.ru/dev/disk/api/reference/capacity-docpage/
 * @type {string}
 */
 ...
 * @see https://yandex.ru/dev/disk/api/reference/meta-docpage/
 * @see https://yandex.ru/dev/disk/api/reference/public-docpage/#meta
 *
 * @type {string}
 */
 ...
 * @see https://yandex.ru/dev/disk/api/reference/all-files-docpage/
 * @type {string}
 */
const API_FILES_URL = `${API_RESOURCES_URL}/files`;
/**
 * URL for getting list of recently uploaded files
 * @see https://yandex.ru/dev/disk/api/reference/recent-upload-docpage/
 * @type {string}
 */
 ...
 * @see https://yandex.ru/dev/disk/api/reference/upload-ext-docpage/
 * @see https://yandex.ru/dev/disk/api/reference/public-docpage/#download
 * @type {string}
 */
 ...
 * @see https://yandex.ru/dev/disk/api/reference/copy-docpage/
 * @type {string}
 */
const API_COPY_URL = `${API_RESOURCES_URL}/copy`;
/**
 * URL for moving file or folder
 * @see https://yandex.ru/dev/disk/api/reference/move-docpage/
 * @type {string}
 */
 ...
 * @see https://yandex.ru/dev/disk/api/reference/publish-docpage/#publish
 * @type {string}
 */
const API_PUBLISH_URL = `${API_RESOURCES_URL}/publish`;
/**
 * URL for unpublishing (closing public saccess to) resource
 * @see https://yandex.ru/dev/disk/api/reference/publish-docpage/#unpublish-q
 * @type {string}
 */
 ...
 * @see https://yandex.ru/dev/disk/api/reference/public-docpage/#save
 * @type {string}
 */
 ...
 * @see https://yandex.ru/dev/disk/api/reference/recent-public-docpage/
 * @type {string}
 */
 ...
 * @see https://yandex.ru/dev/disk/api/reference/trash-delete-docpage/
 * @type {string}
 */
const API_TRASH_URL = `${API_DISK_URL}/trash/resources`;
/**
 * URL for restoring files from the trash
 * @see https://yandex.ru/dev/disk/api/reference/trash-restore-docpage/
 * @type {string}
 */

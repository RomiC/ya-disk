 ...
 * @type {string}
 */
export const API_BASE_URL = 'https://cloud-api.yandex.net/v1';
 ...
 * @type {string}
 */
export const API_DISK_URL = `${API_BASE_URL}/disk`;
/**
 ...
 * @type {string}
 */
export const API_RESOURCES_URL = `${API_DISK_URL}/resources`;
 ...
 * @type {string}
 */
export const API_FILES_URL = `${API_RESOURCES_URL}/files`;
/**
 * URL for getting list of recently uploaded files
 * @see https://tech.yandex.com/disk/api/reference/recent-upload-docpage/
 * @type {string}
 */
export const API_RECENT_FILES_URL = `${API_RESOURCES_URL}/last-uploaded`;

/**
 * URL for requesting upload link for the file
 * @type {string}
 */
export const API_UPLOAD_LINK_URL = `${API_RESOURCES_URL}/upload`;
/**
 ...
 * @type {string}
 */
export const API_DOWNLOAD_LINK_URL = `${API_RESOURCES_URL}/download`;
 ...
 * @type {string}
 */
export const API_COPY_URL = `${API_RESOURCES_URL}/copy`;
/**
 * URL for moving file or folder
 * @see https://tech.yandex.com/disk/api/reference/move-docpage/
 * @type {string}
 */
export const API_MOVE_URL = `${API_RESOURCES_URL}/move`;
 ...
 * @type {string}
 */
export const API_PUBLISH_URL = `${API_RESOURCES_URL}/publish`;
/**
 * URL to unpublish (closing public access to) resource
 * @see https://tech.yandex.com/disk/api/reference/publish-docpage/#unpublish-q
 * @type {string}
 */
export const API_UNPUBLISH_URL = `${API_RESOURCES_URL}/unpublish`;
 ...
 * @type {string}
 */
export const API_PUBLIC_RESOURCES_URL = `${API_DISK_URL}/public/resources`;
 ...
 * @type {string}
 */
export const API_PUBLIC_DOWNLOAD_URL = `${API_PUBLIC_RESOURCES_URL}/download`;
 ...
 * @type {string}
 */
export const API_SAVE_TO_DISK_URL = `${API_RESOURCES_URL}/save-to-disk`;
 ...
 * @type {string}
 */
export const API_PUBLIC_URL = `${API_RESOURCES_URL}/public`;
 ...
 * @type {string}
 */
export const API_TRASH_URL = `${API_DISK_URL}/trash/resources`;
/**
 * URL for restoring files from the trash
 * @see https://tech.yandex.com/disk/api/reference/trash-restore-docpage/
 * @type {string}
 */
export const API_RESTORE_URL = `${API_TRASH_URL}/restore`;
 ...
 * @type {string}
 */
export const API_OPERATIONS_URL = `${API_DISK_URL}/operations`;

...
resources.publish(API_TOKEN, 'disk:/fileOrFolderName', console.log, console.error);
```
...
resources.unpublish(API_TOKEN, 'disk:/fileOrFolderName', console.log, console.error);
```
...
publicResources.list(API_TOKEN, { limit: 10, type: 'file' }, console.log, console.error);
```
...
trash.restore(API_TOKEN, '/foo/photo.png', 'photo-restored.png', true, console.log, console.error);
```
